...
theta = zeros(3, 1);
[theta1, J1] = gradientDescentMulti(X, y, theta, 0.03,  2000);
% [theta2, J2] = gradientDescentMulti(X, y, theta, 0.1,1000);
% [theta3, J3] = gradientDescentMulti(X, y, theta, 0.001,80000);
